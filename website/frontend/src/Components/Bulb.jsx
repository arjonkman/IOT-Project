        ...
        <>
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" xmlnsXlink="http://www.w3.org/1999/xlink" enableBackground="new 0 0 512 512">
                <g>
                    ...
                    <linearGradient y2="0%" x2="100%" y1="0%" x1="0%" id="F1g"><stop stopColor="#00FF00" offset="0%" id="F1gst1"/><stop stopColor="#FFFFFF" offset="0%" id="F1gst2"/></linearGradient>
                </g>
            </svg>  
        </>
    )
